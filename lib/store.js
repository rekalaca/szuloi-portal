...
export const AppStore = {
  ...
  async deleteUser(u) {
    ...
    // Szent és sérthetetlen főadminisztrátori védelem
    if (targetEmail === 'rekalaca@gmail.com') {
      console.warn('A főadminisztrátor (rekalaca@gmail.com) fiókja védett, nem törölhető.');
      return;
    }
